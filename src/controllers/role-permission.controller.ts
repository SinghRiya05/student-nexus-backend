...
export class RolePermissionController {
  ...
  createOrUpdateRolePermissions = async (req: Request, res: Response) => {
    ...
    sendResponse(res, STATUS_CODES.CREATED, true, "Role permissions updated successfully", result);
  };
  ...
  getPermissionsByRole = async (req: Request, res: Response) => {
    ...
    sendResponse(res, STATUS_CODES.SUCCESS, true, "Permissions retrieved successfully", result);
  };
  ...
  updatePermissionsForRole = async (req: Request, res: Response) => {
    ...
    sendResponse(res, STATUS_CODES.SUCCESS, true, "Permissions updated successfully", result);
  };
  ...
  deleteRolePermissions = async (req: Request, res: Response) => {
    ...
    sendResponse(res, STATUS_CODES.SUCCESS, true, "Role permissions deleted successfully", result);
  };
  ...
  addPermissionToRole = async (req: Request, res: Response) => {
    ...
    sendResponse(res, STATUS_CODES.SUCCESS, true, "Permission added to role successfully",
      result
    );
  };
  ...
  removePermissionFromRole = async (req: Request, res: Response) => {
    ...
    sendResponse(res, STATUS_CODES.SUCCESS, true, "Permission removed from role successfully", result);
  };
}